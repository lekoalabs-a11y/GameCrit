...
export default defineConfig({
  base: './', // Assure que les chemins des fichiers CSS/JS sont relatifs
  plugins,
  resolve: {
    alias: {
  ...
  root: "client", // Définit le dossier client comme source
  build: {
    outDir: "../dist/public", // Sortie du build dans dist/public à la racine
    emptyOutDir: true,
  },
  server: {
    port: 3000,
